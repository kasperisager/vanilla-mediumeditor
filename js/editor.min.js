...
!function(t,o){o.Editor=o.Editor||function(o){this.options={textarea:".js-text-box"},o&&t.extend(this.options,o)},Editor.prototype.attachEditor=function(o){var i=t(o);if(!i.data("editor")){var a=t('<div class="editor js-editor"></div>');i.after(a);var e=new MediumEditor(a[0],{placeholder:"Awaiting orders!"});a.html(i.val()),a.html()&&a.removeClass("medium-editor-placeholder"),a.on("input",function(){i.val(a.html())}),gdn.atCompleteInit(a),i.data("editor",e),i.data("contentEditable",a),i.addClass("Hidden")}},Editor.prototype.attachEditorHandler=function(){var o=this;t(this.options.textarea).each(function(){o.attachEditor(this)})},Editor.prototype.clearEditor=function(o){var i=t(o).data("contentEditable");i.empty()},Editor.prototype.clearEditorHandler=function(o){var i=this;t(this.options.textarea,o.target).each(function(){i.clearEditor(this)})}}(jQuery,window,document);
